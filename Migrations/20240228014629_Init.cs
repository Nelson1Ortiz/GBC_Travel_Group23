    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 10001, "American Airlines", new DateTime(2024, 2, 28, 21, 46, 29, 369, DateTimeKind.Local).AddTicks(9419), 1002, new DateTime(2024, 2, 28, 20, 46, 29, 369, DateTimeKind.Local).AddTicks(9372), 1001, "AA101", "Boeing 777", 350.0, 300 },
                    { 10002, "American Airlines", new DateTime(2024, 3, 6, 21, 46, 29, 369, DateTimeKind.Local).AddTicks(9424), 1001, new DateTime(2024, 3, 6, 20, 46, 29, 369, DateTimeKind.Local).AddTicks(9423), 1002, "AA102", "Boeing 777", 360.0, 300 },
                    { 10003, "United Airlines", new DateTime(2024, 2, 28, 22, 46, 29, 369, DateTimeKind.Local).AddTicks(9427), 1004, new DateTime(2024, 2, 28, 20, 46, 29, 369, DateTimeKind.Local).AddTicks(9426), 1003, "UA203", "Boeing 787", 450.0, 250 },
                    { 10004, "United Airlines", new DateTime(2024, 3, 6, 22, 46, 29, 369, DateTimeKind.Local).AddTicks(9430), 1003, new DateTime(2024, 3, 6, 20, 46, 29, 369, DateTimeKind.Local).AddTicks(9429), 1004, "UA204", "Boeing 787", 460.0, 250 },
                    { 10005, "Delta Airlines", new DateTime(2024, 2, 28, 23, 46, 29, 369, DateTimeKind.Local).AddTicks(9434), 1006, new DateTime(2024, 2, 28, 20, 46, 29, 369, DateTimeKind.Local).AddTicks(9433), 1005, "DL305", "Airbus A330", 550.0, 290 },
                    { 10006, "Delta Airlines", new DateTime(2024, 3, 6, 23, 46, 29, 369, DateTimeKind.Local).AddTicks(9437), 1005, new DateTime(2024, 3, 6, 20, 46, 29, 369, DateTimeKind.Local).AddTicks(9436), 1006, "DL306", "Airbus A330", 560.0, 290 },
                    { 10007, "British Airways", new DateTime(2024, 2, 29, 6, 46, 29, 369, DateTimeKind.Local).AddTicks(9440), 1008, new DateTime(2024, 2, 28, 20, 46, 29, 369, DateTimeKind.Local).AddTicks(9439), 1007, "BA407", "Boeing 747", 800.0, 345 },
                    { 10008, "British Airways", new DateTime(2024, 3, 7, 6, 46, 29, 369, DateTimeKind.Local).AddTicks(9482), 1007, new DateTime(2024, 3, 6, 20, 46, 29, 369, DateTimeKind.Local).AddTicks(9480), 1008, "BA408", "Boeing 747", 810.0, 345 },
                    { 10009, "Lufthansa", new DateTime(2024, 2, 29, 7, 46, 29, 369, DateTimeKind.Local).AddTicks(9485), 1010, new DateTime(2024, 2, 28, 20, 46, 29, 369, DateTimeKind.Local).AddTicks(9484), 1009, "LH509", "Airbus A350", 850.0, 320 },
                    { 10010, "Lufthansa", new DateTime(2024, 3, 7, 7, 46, 29, 369, DateTimeKind.Local).AddTicks(9488), 1009, new DateTime(2024, 3, 6, 20, 46, 29, 369, DateTimeKind.Local).AddTicks(9487), 1010, "LH510", "Airbus A350", 860.0, 320 },
                    { 10011, "Emirates", new DateTime(2024, 2, 29, 1, 46, 29, 369, DateTimeKind.Local).AddTicks(9491), 1012, new DateTime(2024, 2, 28, 20, 46, 29, 369, DateTimeKind.Local).AddTicks(9490), 1011, "EM611", "Boeing 777", 700.0, 360 },
                    { 10012, "Emirates", new DateTime(2024, 3, 7, 1, 46, 29, 369, DateTimeKind.Local).AddTicks(9495), 1011, new DateTime(2024, 3, 6, 20, 46, 29, 369, DateTimeKind.Local).AddTicks(9494), 1012, "EM612", "Boeing 777", 710.0, 360 },
                    { 10013, "Qantas", new DateTime(2024, 2, 29, 16, 46, 29, 369, DateTimeKind.Local).AddTicks(9500), 1014, new DateTime(2024, 2, 28, 20, 46, 29, 369, DateTimeKind.Local).AddTicks(9499), 1013, "QF713", "Boeing 787", 1000.0, 236 },
                    { 10014, "Qantas", new DateTime(2024, 3, 7, 16, 46, 29, 369, DateTimeKind.Local).AddTicks(9506), 1013, new DateTime(2024, 3, 6, 20, 46, 29, 369, DateTimeKind.Local).AddTicks(9505), 1014, "QF714", "Boeing 787", 1010.0, 236 },
                    { 10015, "Air France", new DateTime(2024, 2, 29, 8, 46, 29, 369, DateTimeKind.Local).AddTicks(9509), 1016, new DateTime(2024, 2, 28, 20, 46, 29, 369, DateTimeKind.Local).AddTicks(9508), 1015, "AF815", "Boeing 777", 900.0, 310 },
                    { 10016, "Air France", new DateTime(2024, 3, 7, 8, 46, 29, 369, DateTimeKind.Local).AddTicks(9513), 1015, new DateTime(2024, 3, 6, 20, 46, 29, 369, DateTimeKind.Local).AddTicks(9512), 1016, "AF816", "Boeing 777", 910.0, 310 }
                });
